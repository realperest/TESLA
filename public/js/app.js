...
function isYoutubeSection(section) {
  return section === 'youtube' || section === 'youtube_v2' || section === 'youtube_v3' || section === 'youtube_v4';
}
